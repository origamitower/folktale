...
prev_doc: v2.1.0/contributing/bugfixes
next_doc: v2.1.0/contributing/documentation
---
...
Every feature patch should include automated tests. These tests should cover the possible usages of the functionality in question, and ideally be described as mathematical properties, so they can be ran over a broad range of inputs. Refer to the [test writing guide]({% link _docs/v2.1.0/contributing/tests.md %}) for details :)
...
The [documentation guide]({% link _docs/v2.1.0/contributing/documentation.md %}) goes into more details about meta-data annotations and markdown documentation.
