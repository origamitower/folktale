---
title: Overview
prev_doc: v2.3.0/download
next_doc: v2.3.0/changelog
---

Folktale is a library to support a functional style of programming in JavaScript.
In its current version Folktale provides utilities for [combining functions](/api/v2.3.0/en/folktale.core.lambda.html),
[transforming objects](/api/v2.3.0/en/folktale.core.object.html), [modelling data](/api/v2.3.0/en/folktale.adt.html), [handling errors](/api/v2.3.0/en/folktale.html#cat-handling-failures), and [concurrency](/api/v2.3.0/en/folktale.concurrency.task.html).

The [API reference](/api/v2.3.0/en/folktale.html) provides detailed documentation
...
Another option is using a functional combinator like [constant](/api/v2.3.0/en/folktale.core.lambda.constant.constant.html):
...
Folktale's [`core/lambda`](/api/v2.3.0/en/folktale.core.lambda.html) module tries to provide
...
structures to help with error handling:
  ...
  - [Maybe](/api/v2.3.0/en/folktale.maybe.html) - A structure that helps handling values
  ...
  - [Result](/api/v2.3.0/en/folktale.result.html) - A structure that models the result
  ...
  - [Validation](/api/v2.3.0/en/folktale.validation.html) - A structure that helps with
...
More documentation can be found in the [`adt/union`](/api/v2.3.0/en/folktale.adt.union.html)
module reference.
...
The documentation for the [`concurrency/task`](/api/v2.3.0/en/folktale.concurrency.task.html)
